...
import Head from "next/head" // ✅ SEO uchun
...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <Head>
        <title>Talaba Hub | Talaba uy topish va ish e’lonlari O‘zbekiston</title>
        <meta
          name="description"
          content="Talaba Hub orqali O‘zbekiston bo‘ylab talaba uylarini toping va ish e’lonlariga murojaat qiling. Barcha e’lonlar real va yangilanadi."
        />
        <meta
          name="keywords"
          content="talaba uy, ish e’lonlari, O‘zbekiston, talabalar, Talaba Hub"
        />
      </Head>
