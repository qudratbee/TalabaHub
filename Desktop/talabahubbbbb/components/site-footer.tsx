      ...
      <div className="mx-auto max-w-7xl px-4 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              <li className="text-sm text-muted-foreground">ilhamovqudratjon738@gmail.com</li>
              <li className="text-sm text-muted-foreground">+998 949041415</li>
              <li className="text-sm text-muted-foreground">Toshkent, Namangan</li>
            </ul>
          </div>
        </div>
